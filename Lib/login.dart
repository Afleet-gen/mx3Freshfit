...
class _MyAppLState extends State<MyAppL> {
  ...
  void addaccount(String cusername) async {
    ...
    http.Response response1 = await http.post(
      Uri.parse('http://192.168.100.226:8000/event/'),
  ...
  void createverification(String username) async {
    ...
    http.Response response1 = await http.post(
      Uri.parse('http://192.168.100.226:8000/verified2/'),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
...
//save the token for next time
  ...
  //int State = 0;
  fireOne() {
    //audioCache.play(AssetSource('assets/assets/notificationz.mp3'));
  ...
  Future getStudent() async {
    http.Response response1 = await http.get(
      Uri.parse('http://192.168.100.226:8000/students/'),
      headers: <String, String>{
  ...
  Future createpic() async {
    http.Response response1 = await http.post(
      Uri.parse('http://192.168.100.226:8000/profpic/'),
      headers: <String, String>{
        'Content-Type': 'application/json',
      }, //'id','sender','message_me','receiver','time'
      body: jsonEncode(<String, String>{
...
//save the token for next time
  ...
  Future create1() async {
    http.Response response1 = await http.post(
      Uri.parse('http://192.168.100.226:8000/registerff/'),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
...
//save the token for next time
    ...
    http.Response response1 = await http.post(
      Uri.parse('http://192.168.100.226:8000/api-token-auth_forfF/'),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
      },
      body: jsonEncode(<String, String>{
          ...
          child: Card(
              ...
              child: Center(
                ...
                child: Column(children: [
                  Container(
                    height: MediaQuery.of(context).size.height*.04, //getHdimention(15),
                  ),
                  ...
                  Container(
                    ...
                    child: Center(
                      child: Card(
                          ...
                          child: Column(
                            mainAxisAlignment: widget.title == "addaccount"
                                ...
                                children: [
                                  Row(children: [
                                    Text(
                                      ...
                                      //Our app makes it easy to keep track of your children's bus locations
                                      //Making School Days Easier, One Ride at a Time
                                      widget.title == "addaccount"
                                          //there's no actual reason for this ... i just did it because it was a direct copy from buswise app login
                                          ? "Need another\naccount?"
                                          : "", //  Grow
                                      style: GoogleFonts.montserrat(
                                          fontWeight:
                                              widget.title == "addaccount"
                                                  ? FontWeight.w500
                                                  : FontWeight.bold,
                                          fontSize: widget.title != "addaccount"
                                              ? MediaQuery.of(context)
                                                  ...
                                                  : 65
                                              : 35,
                                          //MediaQuery.of(context).size.width<=600? 55 :65,
                                          color: Colors.white),
                                    ...
                                    widget.title == "addaccount"
                                        ? SizedBox(
                                            ...
                                            child: const Center(
                                                child:
                                                    null /*Image.asset(
                                                  'assets/bwfallout.png')*/
                                                ))
                                        : Text(
                                            widget.title == "addaccount"
                                                ? ""
                                                : " ", // Connect Grow Our app makes it easy \nto keep track of all your kids
                                            style: GoogleFonts.montserrat(
                                                fontWeight: 0 == 1
                                                    ? FontWeight.normal
                                                    : FontWeight.bold,
